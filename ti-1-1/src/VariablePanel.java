	...
	class MyTask extends TimerTask {  
	    ...
	    public void run() {  
	    	...
	    	if(panel.k*16+200 >= panel.getWidth()){
	    		panel.setPreferredSize(new Dimension(panel.k*25+200, panel.getHeight()));
	    		panel.setSize(panel.k*25+200, panel.getHeight());    //两句一起写才有效果，不知道为什么
	    	}
	    	...
	    	JScrollBar scrollBar = getHorizontalScrollBar();    //得到竖直方向的滚动条
